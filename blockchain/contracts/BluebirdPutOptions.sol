...
contract BluebirdPutOptions {
    ...
    constructor(address _nftFeed, address _nftToken, uint256[] memory _strikePrices, uint256 _premium, uint256 _expiry) {
        // Price feed of NFT
    ...
    function buyOption(uint ID) public {
        ...
        require(nftToken.transferFrom(msg.sender, nftOpts[ID].writer, nftOpts[ID].premium), "Incorrect amount of NFT Token sent for premium");
    ...
    function exercise(uint ID) public payable {
        ...
        //Pay buyer contract amount of Nfttoken
